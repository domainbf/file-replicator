...
const KNOWN_RDAP_SERVERS: Record<string, string> = {
  ...
  'jobs': 'https://rdap.nic.name',
  'mobi': 'https://rdap.nic.mobi',
  'coop': 'https://rdap.nic.mobi',
  'aero': 'https://rdap.nic.mobi',
  ...
  'lol': 'https://rdap.nic.google',
  'woo': 'https://rdap.nic.google',
  'android': 'https://rdap.nic.google',
  ...
  'bid': 'https://rdap.centralnic.com/bid',
  'center': 'https://rdap.centralnic.com/center',
  'chat': 'https://rdap.centralnic.com/chat',
  'domains': 'https://rdap.centralnic.com/domains',
  'download': 'https://rdap.centralnic.com/download',
  'download': 'https://rdap.centralnic.com/download',
  'fans': 'https://rdap.centralnic.com/fans',
  'foundation': 'https://rdap.centralnic.com/foundation',
  'game': 'https://rdap.centralnic.com/game',
  'games': 'https://rdap.centralnic.com/games',
  'gaming': 'https://rdap.centralnic.com/gaming',
  'photo': 'https://rdap.centralnic.com/photo',
  'photos': 'https://rdap.centralnic.com/photos',
  'pictures': 'https://rdap.centralnic.com/pictures',
  'press': 'https://rdap.centralnic.com/press',
  'racing': 'https://rdap.centralnic.com/racing',
  'show': 'https://rdap.centralnic.com/show',
  'video': 'https://rdap.centralnic.com/video',
  'videos': 'https://rdap.centralnic.com/videos',
  ...
  'host': 'https://rdap.host',
  'click': 'https://rdap.uniregistry.net/rdap',
  'codes': 'https://rdap.uniregistry.net/rdap',
  'solutions': 'https://rdap.uniregistry.net/rdap',
  'domains': 'https://rdap.centralnic.com/domains',
  'reviews': 'https://rdap.uniregistry.net/rdap',
  'marketing': 'https://rdap.uniregistry.net/rdap',
  'restaurant': 'https://rdap.uniregistry.net/rdap',
  'health': 'https://rdap.uniregistry.net/rdap',
  'attorney': 'https://rdap.uniregistry.net/rdap',
  'dental': 'https://rdap.uniregistry.net/rdap',
  'doctor': 'https://rdap.uniregistry.net/rdap',
  'accountant': 'https://rdap.uniregistry.net/rdap',
  'engineer': 'https://rdap.uniregistry.net/rdap',
  // ccTLDs - 主流
  ...
  'ng': 'https://rdap.nic.ng',
  'pk': 'https://rdap.pknic.net.pk',
  'bh': 'https://rdap.bh',
  'ae': 'https://rdap.aeda.net.ae',
  'il': 'https://rdap.isoc.org.il',
  'eg': 'https://rdap.ripe.net',
  'ma': 'https://rdap.maroc.ma',

  // IDN ccTLDs (需要 Punycode 编码)
  'xn--fiqs8s': 'https://rdap.cnnic.cn/rdap', // .中国
  'xn--fiq228c': 'https://rdap.cnnic.cn/rdap', // .中文网
  'xn--55qx5d': 'https://rdap.cnnic.cn/rdap', // .中文网
  'xn--3e0b707e': 'https://rdap.kr', // .한국
  'xn--80akhbyknj4f': 'https://rdap.ua', // .укр
  'xn--p1ai': 'https://rdap.ripn.net/rdap', // .рф
  'xn--wgbl6a': 'https://rdap.qatar.qa', // .قطر
  'xn--4gbrim': 'https://rdap.isoc.org.il', // .مصر
};
